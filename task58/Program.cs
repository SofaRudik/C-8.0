...
int[,] Release(int[,] FirstMatrix, int[,] SecondMatrix)
{
...
Console.WriteLine("Начальный 1-вый массив: ");
Print(FirstMatrix);
Console.WriteLine("Начальный 2-вый массив: ");
Print(SecondMatrix);
Console.WriteLine("Результат:");
Print(Release(FirstMatrix, SecondMatrix));